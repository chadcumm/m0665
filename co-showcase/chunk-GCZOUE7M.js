...
function PatientSummary_Conditional_5_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "span", 8)(2, "mpage-icon", 10);
    \u0275\u0275text(3, "home");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Address ");
    \u0275\u0275elementEnd();
...
function PatientSummary_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(26, PatientSummary_Conditional_5_Conditional_26_Template, 7, 1, "div", 7);
    \u0275\u0275conditionalCreate(27, PatientSummary_Conditional_5_Conditional_27_Template, 7, 1, "div", 7);
  }
  if (rf & 2) {
    let tmp_7_0;
    let tmp_8_0;
...
function PatientSummary_Conditional_15_Case_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, PatientSummary_Conditional_15_Case_0_Conditional_1_Conditional_4_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PatientSummary_Conditional_15_Case_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "mpage-table", 13);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(1, PatientSummary_Conditional_15_Case_0_Conditional_1_Template, 5, 3, "div", 14);
  }
  if (rf & 2) {
    let tmp_5_0;
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function PatientSummary_Conditional_15_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "mpage-table", 16);
...
function PatientSummary_Conditional_15_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 12)(1, "mpage-table", 16);
    ...
    \u0275\u0275element(6, "mpage-tree", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "mpage-scroll-bar", 20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function PatientSummary_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, PatientSummary_Conditional_15_Case_0_Template, 2, 5)(1, PatientSummary_Conditional_15_Case_1_Template, 1, 4, "mpage-table", 11)(2, PatientSummary_Conditional_15_Case_2_Template, 1, 4, "mpage-table", 11)(3, PatientSummary_Conditional_15_Case_3_Template, 8, 10, "div", 12);
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r2 = \u0275\u0275nextContext();
...
var PatientSummary = class _PatientSummary {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PatientSummary, selectors: [["app-patient-summary"]], decls: 16, vars: 5, consts: [[1, "summary-container"], [1, "demographics-banner", "flex", "flex-center-items", "flex-gap"], ["coButton", "icon", 3, "click"], [1, "flex-fill"], ["coButton", "stroked", "color", "warn", 3, "click"], ["buttonType", "default", "buttonColor", "default", "selectedButtonColor", "primary", 3, "clickTab", "tabs", "defaultTab"], ["coRemainingScreenSpace", "", 1, "tab-content", 3, "shorten"], [1, "demo-field"], [1, "demo-label"], [1, "demo-value"], [1, "demo-icon"], [3, "data", "columnConfig", "params"], [1, "encounters-section"], [3, "columnConfigChange", "clickRow", "data", "columnConfig", "params"], [1, "allergy-detail"], [1, "allergy-comments"], [3, "columnConfigChange", "data", "columnConfig", "params"], [1, "tree-container"], [1, "tree-scroll-wrapper"], [3, "label", "searchable", "scriptParams"], [3, "vertical", "allowWheelScroll"]], template: function PatientSummary_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(9, "mpage-icon");
      \u0275\u0275text(10, "logout");
      \u0275\u0275elementEnd();
      \u0275\u0275text(11, " Leave ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(12, "tabbed-menu", 5);
...
(() => {
  ...
  <div class="demographics-banner flex flex-center-items flex-gap">
    <button coButton="icon" (click)="goBack()">
      <mpage-icon>arrow_back</mpage-icon>
    </button>
    ...
    @if (person(); as p) {
      ...
      @if (addressInline(); as addr) {
        <div class="demo-field">
          <span class="demo-label">
            <mpage-icon class="demo-icon">home</mpage-icon> Address
          </span>
      ...
      @if (homePhone(); as phone) {
        <div class="demo-field">
          <span class="demo-label">
            <mpage-icon class="demo-icon">phone</mpage-icon> Phone
          </span>
    ...
    <button coButton="stroked" color="warn" (click)="goBack()">
      <mpage-icon>logout</mpage-icon> Leave
    </button>
  </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PatientSummary, { className: "PatientSummary", filePath: "src/app/patient-summary/patient-summary.ts", lineNumber: 43 });
})();
export {
  PatientSummary
};
//# sourceMappingURL=chunk-GCZOUE7M.js.map
