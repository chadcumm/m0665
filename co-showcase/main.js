...
var routes = [
  ...
  { path: "search", loadComponent: () => import("./chunk-ZHKGYLMY.js").then((m) => m.Search) },
  {
    path: "patient/:personId/:encntrId",
    loadComponent: () => import("./chunk-JE53TQDS.js").then((m) => m.PatientSummary),
