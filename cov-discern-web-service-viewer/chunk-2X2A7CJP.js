...
function ParameterManager_Conditional_18_Conditional_6_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 23);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", it_r18.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(it_r18.label);
  }
}
function ParameterManager_Conditional_18_Conditional_6_Conditional_44_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 33)(1, "input", 52);
    \u0275\u0275listener("input", function ParameterManager_Conditional_18_Conditional_6_Conditional_44_For_7_Template_input_input_1_listener($event) {
      const $index_r21 = \u0275\u0275restoreView(_r20).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOption($index_r21, "label", $event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 53);
    \u0275\u0275listener("input", function ParameterManager_Conditional_18_Conditional_6_Conditional_44_For_7_Template_input_input_2_listener($event) {
      const $index_r21 = \u0275\u0275restoreView(_r20).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOption($index_r21, "value", $event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 37);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_6_Conditional_44_For_7_Template_button_click_3_listener() {
      const $index_r21 = \u0275\u0275restoreView(_r20).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeBuiltInOption($index_r21));
    });
    \u0275\u0275elementStart(4, "span", 5);
    \u0275\u0275text(5, "close");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("value", opt_r22.label);
    \u0275\u0275advance();
...
function ParameterManager_Conditional_18_Conditional_6_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 32);
    \u0275\u0275repeaterCreate(6, ParameterManager_Conditional_18_Conditional_6_Conditional_44_For_7_Template, 6, 2, "div", 33, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementStart(8, "button", 34);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_6_Conditional_44_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.addBuiltInOption());
    });
...
function ParameterManager_Conditional_18_Conditional_6_Conditional_45_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40)(1, "input", 52);
    \u0275\u0275listener("input", function ParameterManager_Conditional_18_Conditional_6_Conditional_45_For_7_Template_input_input_1_listener($event) {
      const $index_r25 = \u0275\u0275restoreView(_r24).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInPreset($index_r25, "label", $event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 54);
    \u0275\u0275listener("input", function ParameterManager_Conditional_18_Conditional_6_Conditional_45_For_7_Template_input_input_2_listener($event) {
      const $index_r25 = \u0275\u0275restoreView(_r24).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInPreset($index_r25, "preset", $event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 37);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_6_Conditional_45_For_7_Template_button_click_3_listener() {
      const $index_r25 = \u0275\u0275restoreView(_r24).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeBuiltInPreset($index_r25));
    });
    \u0275\u0275elementStart(4, "span", 5);
    \u0275\u0275text(5, "close");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    const preset_r26 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("value", preset_r26.label);
    \u0275\u0275advance();
    \u0275\u0275property("value", preset_r26.preset);
  }
}
function ParameterManager_Conditional_18_Conditional_6_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, ParameterManager_Conditional_18_Conditional_6_Conditional_45_For_7_Template, 6, 2, "div", 40, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementStart(8, "button", 34);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_6_Conditional_45_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.addBuiltInPreset());
    });
    \u0275\u0275elementStart(9, "span", 5);
    \u0275\u0275text(10, "add");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11, " Add Preset ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const type_r15 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275repeater(type_r15.presets || \u0275\u0275pureFunction0(0, _c0));
  }
}
function ParameterManager_Conditional_18_Conditional_6_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
...
function ParameterManager_Conditional_18_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "select", 22);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_6_Template_select_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOverride("inputType", $event));
    });
    \u0275\u0275repeaterCreate(11, ParameterManager_Conditional_18_Conditional_6_For_12_Template, 2, 2, "option", 23, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 18)(14, "label");
    \u0275\u0275text(15, "Label ");
    \u0275\u0275elementStart(16, "span", 48);
    \u0275\u0275text(17, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "input", 49);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_6_Template_input_ngModelChange_18_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(23, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "textarea", 50);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_6_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOverride("description", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 18)(26, "label");
    \u0275\u0275text(27, "Default Value ");
    \u0275\u0275elementStart(28, "span", 48);
    \u0275\u0275text(29, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "input", 49);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_6_Template_input_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(35, "(overridable)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "input", 49);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_6_Template_input_ngModelChange_36_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOverride("placeholder", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div", 27)(38, "label")(39, "input", 51);
    \u0275\u0275listener("change", function ParameterManager_Conditional_18_Conditional_6_Template_input_change_39_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOverride("allowEmpty", $event.target.checked));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(40, " Allow Empty ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "label")(42, "input", 51);
    \u0275\u0275listener("change", function ParameterManager_Conditional_18_Conditional_6_Template_input_change_42_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.updateBuiltInOverride("unquoted", $event.target.checked));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(43, " Unquoted (numeric) ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(44, ParameterManager_Conditional_18_Conditional_6_Conditional_44_Template, 12, 1, "div", 18);
    \u0275\u0275conditionalCreate(45, ParameterManager_Conditional_18_Conditional_6_Conditional_45_Template, 12, 1, "div", 18);
    \u0275\u0275conditionalCreate(46, ParameterManager_Conditional_18_Conditional_6_Conditional_46_Template, 5, 1, "div", 47);
  }
  if (rf & 2) {
    const type_r15 = \u0275\u0275nextContext();
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("checked", type_r15.allowEmpty);
    \u0275\u0275advance(3);
    \u0275\u0275property("checked", type_r15.unquoted);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(type_r15.inputType === "select" ? 44 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(type_r15.inputType === "datetime" || type_r15.inputType === "date" || type_r15.inputType === "time" ? 45 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(type_r15.cclFormat ? 46 : -1);
  }
}
function ParameterManager_Conditional_18_Conditional_7_For_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", it_r28.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(it_r28.label);
  }
}
function ParameterManager_Conditional_18_Conditional_7_Conditional_35_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_7_Conditional_35_For_5_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_417_r31 = \u0275\u0275restoreView(_r30).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateCustomOption(\u0275$index_417_r31, "label", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 36);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_7_Conditional_35_For_5_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_417_r31 = \u0275\u0275restoreView(_r30).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateCustomOption(\u0275$index_417_r31, "value", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 37);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_7_Conditional_35_For_5_Template_button_click_3_listener() {
      const \u0275$index_417_r31 = \u0275\u0275restoreView(_r30).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeCustomOption(\u0275$index_417_r31));
    });
    \u0275\u0275elementStart(4, "span", 5);
    \u0275\u0275text(5, "close");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", opt_r32.label);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", opt_r32.value);
  }
}
...
function ParameterManager_Conditional_18_Conditional_7_Conditional_36_For_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_7_Conditional_36_For_9_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_450_r35 = \u0275\u0275restoreView(_r34).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateCustomPreset(\u0275$index_450_r35, "label", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 41);
    \u0275\u0275listener("ngModelChange", function ParameterManager_Conditional_18_Conditional_7_Conditional_36_For_9_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_450_r35 = \u0275\u0275restoreView(_r34).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.updateCustomPreset(\u0275$index_450_r35, "preset", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 37);
    \u0275\u0275listener("click", function ParameterManager_Conditional_18_Conditional_7_Conditional_36_For_9_Template_button_click_3_listener() {
      const \u0275$index_450_r35 = \u0275\u0275restoreView(_r34).$index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeCustomPreset(\u0275$index_450_r35));
    });
    \u0275\u0275elementStart(4, "span", 5);
    \u0275\u0275text(5, "close");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    const preset_r36 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", preset_r36.label);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", preset_r36.preset);
  }
}
...
function ParameterManager_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(6, ParameterManager_Conditional_18_Conditional_6_Template, 47, 11)(7, ParameterManager_Conditional_18_Conditional_7_Template, 37, 10, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var ParameterManager = class _ParameterManager {
  ...
  // --- Built-in Options management ---
  addBuiltInOption() {
    const type = this.selectedType();
    if (!type)
      return;
    const options = [...type.options || [], { label: "", value: "" }];
    this.updateBuiltInOverride("options", options);
  }
  removeBuiltInOption(index) {
    const type = this.selectedType();
    if (!type)
      return;
    const options = [...type.options || []];
  ...
  updateBuiltInOption(index, field, value) {
    const type = this.selectedType();
    if (!type)
      return;
    const options = [...type.options || []];
  ...
  // --- Built-in Presets management ---
  addBuiltInPreset() {
    const type = this.selectedType();
    if (!type)
      return;
    const presets = [...type.presets || [], { label: "", preset: "" }];
    this.updateBuiltInOverride("presets", presets);
  }
  removeBuiltInPreset(index) {
    const type = this.selectedType();
    if (!type)
      return;
  ...
  updateBuiltInPreset(index, field, value) {
    const type = this.selectedType();
    if (!type)
      return;
    const presets = [...type.presets || []];
    ...
    @if (addingNew()) {
      ...
      <div class="service-detail">
        ...
        @if (isSelectedBuiltIn()) {
          ...
          <div class="form-group">
            <label>Input Type <span class="override-hint">(overridable)</span></label>
            <select [ngModel]="type.inputType" (ngModelChange)="updateBuiltInOverride('inputType', $event)">
              @for (it of inputTypes; track it.value) {
                <option [value]="it.value">{{ it.label }}</option>
              }
            </select>
          ...
          <div class="checkbox-row">
            <label>
              <input type="checkbox" [checked]="type.allowEmpty" (change)="updateBuiltInOverride('allowEmpty', $any($event.target).checked)" />
              Allow Empty
            </label>
            <label>
              <input type="checkbox" [checked]="type.unquoted" (change)="updateBuiltInOverride('unquoted', $any($event.target).checked)" />
              Unquoted (numeric)
            </label>
          </div>

          <!-- Options editor for select types (overridable) -->
          @if (type.inputType === 'select') {
            <div class="form-group">
              <label>Options <span class="override-hint">(overridable)</span></label>
              <div class="options-editor">
                @for (opt of type.options || []; track $index) {
                  <div class="option-row">
                    <input type="text" [value]="opt.label" placeholder="Label"
                      (input)="updateBuiltInOption($index, 'label', $any($event.target).value)" />
                    <input type="text" [value]="opt.value" placeholder="Value"
                      (input)="updateBuiltInOption($index, 'value', $any($event.target).value)" />
                    <button class="btn-icon" (click)="removeBuiltInOption($index)">
                      <span class="material-icons">close</span>
                    </button>
                  </div>
                }
                <button class="btn btn-small btn-secondary" (click)="addBuiltInOption()">
                  <span class="material-icons">add</span> Add Option
                </button>
              </div>
            </div>
          ...
          <!-- Presets editor for datetime types (overridable) -->
          @if (type.inputType === 'datetime' || type.inputType === 'date' || type.inputType === 'time') {
            <div class="form-group">
              <label>Presets <span class="override-hint">(overridable)</span></label>
              <div class="presets-editor">
                @for (preset of type.presets || []; track $index) {
                  <div class="preset-row">
                    <input type="text" [value]="preset.label" placeholder="Label"
                      (input)="updateBuiltInPreset($index, 'label', $any($event.target).value)" />
                    <input type="text" [value]="preset.preset" placeholder="Preset key"
                      (input)="updateBuiltInPreset($index, 'preset', $any($event.target).value)" />
                    <button class="btn-icon" (click)="removeBuiltInPreset($index)">
                      <span class="material-icons">close</span>
                    </button>
                  </div>
                }
                <button class="btn btn-small btn-secondary" (click)="addBuiltInPreset()">
                  <span class="material-icons">add</span> Add Preset
                </button>
              </div>
            </div>
...
//# sourceMappingURL=chunk-2X2A7CJP.js.map
