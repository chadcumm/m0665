...
function ServiceManager_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 17)(4, "code");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ServiceManager_For_15_Conditional_6_Template, 2, 0, "span", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_18_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ServiceManager_Conditional_18_Conditional_18_For_2_Conditional_7_Template, 2, 0, "span", 38);
...
function ServiceManager_Conditional_18_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ServiceManager_Conditional_18_Conditional_18_For_2_Template, 11, 4, "div", 34, _forTrack2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 19)(16, "label");
    \u0275\u0275text(17, "Parameters");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ServiceManager_Conditional_18_Conditional_18_Template, 3, 0, "div", 23);
    \u0275\u0275elementStart(19, "div", 24)(20, "select", 25);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(23, ServiceManager_Conditional_18_For_24_Template, 2, 3, "option", 27, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "label", 28)(26, "input", 29);
...
function ServiceManager_Conditional_19_Conditional_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 30);
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_4_Conditional_0_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const svc_r11 = \u0275\u0275nextContext(2);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ServiceManager_Conditional_19_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275conditionalCreate(0, ServiceManager_Conditional_19_Conditional_4_Conditional_0_Template, 4, 0, "button", 43);
    \u0275\u0275elementStart(1, "button", 44);
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_4_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
  ...
  if (rf & 2) {
    const svc_r11 = \u0275\u0275nextContext();
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.registry.hasUserVersion(svc_r11.id) ? 0 : -1);
  }
}
...
function ServiceManager_Conditional_19_For_21_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 38);
    \u0275\u0275text(1, "required");
    \u0275\u0275elementEnd();
...
function ServiceManager_Conditional_19_For_21_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_19_For_21_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("default: ", p_r13.defaultValueOverride);
  }
}
function ServiceManager_Conditional_19_For_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34)(1, "span", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ServiceManager_Conditional_19_For_21_Conditional_7_Template, 2, 0, "span", 38)(8, ServiceManager_Conditional_19_For_21_Conditional_8_Template, 2, 0, "span", 45);
    \u0275\u0275conditionalCreate(9, ServiceManager_Conditional_19_For_21_Conditional_9_Template, 2, 1, "span", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", p_r13.position, ".");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.getParamTypeLabel(p_r13.parameterTypeKey));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", p_r13.parameterTypeKey, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(p_r13.required ? 7 : 8);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(p_r13.defaultValueOverride ? 9 : -1);
  }
}
function ServiceManager_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 40)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, ServiceManager_Conditional_19_Conditional_4_Template, 5, 1)(5, ServiceManager_Conditional_19_Conditional_5_Template, 4, 0, "button", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 42)(7, "label");
    \u0275\u0275text(8, "Program Name");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(20, ServiceManager_Conditional_19_For_21_Template, 10, 5, "div", 34, _forTrack2);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const svc_r11 = ctx;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.registry.isDefault(svc_r11.id) ? 4 : 5);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(svc_r11.programName);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(svc_r11.description);
    \u0275\u0275advance(3);
...
function ServiceManager_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-help-modal", 47);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "h3");
    \u0275\u0275text(8, "Default vs Custom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "ul")(10, "li")(11, "strong");
    \u0275\u0275text(12, "Default");
    \u0275\u0275elementEnd();
    \u0275\u0275text(13, ' services ship with the application. They can be customized or deleted. Use "Reset to Default" to restore a modified default service.');
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(194, "Import");
    \u0275\u0275elementEnd();
    \u0275\u0275text(195, " \u2014 Loads service definitions from a JSON file. Services are merged; existing IDs are skipped.");
    \u0275\u0275elementEnd()();
...
var ServiceManager = class _ServiceManager {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceManager, selectors: [["app-service-manager"]], decls: 22, vars: 3, consts: [[1, "service-manager-layout"], [1, "service-list-panel"], [1, "panel-header"], [1, "panel-header-actions"], ["title", "Help", 1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn", "btn-small", "btn-primary", 3, "click"], [1, "service-list"], [1, "service-item", 3, "active"], [1, "import-message"], [1, "detail-panel"], [1, "add-new-form"], [1, "service-detail"], [1, "empty-state"], ["title", "Service Manager Help"], [1, "service-item", 3, "click"], [1, "service-item-name"], [1, "service-item-meta"], [1, "badge"], [1, "form-group"], ["type", "text", "placeholder", "e.g., cov_my_new_script", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., My New Script", 3, "ngModelChange", "ngModel"], ["rows", "3", "placeholder", "What does this service do?", 3, "ngModelChange", "ngModel"], [1, "param-list"], [1, "add-param-row"], [3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "checkbox-label"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], [1, "btn", "btn-small", "btn-secondary", 3, "click"], [1, "form-actions"], [1, "btn", "btn-primary", 3, "click"], [1, "btn", "btn-secondary", 3, "click"], [1, "param-item"], [1, "param-position"], [1, "param-name"], [1, "param-key"], [1, "badge", "required"], [1, "btn-icon", 3, "click"], [1, "detail-header"], [1, "btn", "btn-small", "btn-warn"], [1, "detail-field"], [1, "btn", "btn-small", "btn-secondary"], [1, "btn", "btn-small", "btn-warn", 3, "click"], [1, "badge", "optional"], [1, "param-default"], ["title", "Service Manager Help", 3, "closeRequested"]], template: function ServiceManager_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(18, ServiceManager_Conditional_18_Template, 39, 6, "div", 11)(19, ServiceManager_Conditional_19_Template, 22, 5, "div", 12)(20, ServiceManager_Conditional_20_Template, 7, 0, "div", 13);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(21, ServiceManager_Conditional_21_Template, 227, 0, "app-help-modal", 14);
    }
    if (rf & 2) {
      let tmp_1_0;
      let tmp_2_0;
...
//# sourceMappingURL=chunk-6UDPKAN5.js.map
