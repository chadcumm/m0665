...
function ConfigEditor_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigEditor_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigEditor_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "textarea", 22);
    \u0275\u0275listener("ngModelChange", function ConfigEditor_Conditional_34_Template_textarea_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ConfigEditor_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 17, 0);
  }
}
function ConfigEditor_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigEditor_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-help-modal", 23);
    \u0275\u0275listener("closeRequested", function ConfigEditor_Conditional_42_Template_app_help_modal_closeRequested_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
...
var ConfigEditor = class _ConfigEditor {
  ...
  }, decls: 43, vars: 15, consts: [["treeContainer", ""], [1, "config-editor-layout"], [1, "config-toolbar"], [1, "toolbar-left"], [3, "ngModelChange", "ngModel"], [3, "value"], [1, "mode-toggle"], [1, "btn", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn", "btn-small", 3, "click", "disabled"], [1, "toolbar-right"], [1, "btn", "btn-small", "btn-ghost", 3, "click"], [1, "btn", "btn-small", "btn-primary", 3, "click", "disabled"], [1, "error-banner"], [1, "status-banner"], [1, "editor-area"], ["spellcheck", "false", 1, "code-editor", 3, "ngModel"], [1, "tree-container"], [1, "status-bar"], [1, "modified-badge"], [1, "char-count"], ["title", "Config Editor Help"], ["spellcheck", "false", 1, "code-editor", 3, "ngModelChange", "ngModel"], ["title", "Config Editor Help", 3, "closeRequested"]], template: function ConfigEditor_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(30, " Apply ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(31, ConfigEditor_Conditional_31_Template, 4, 1, "div", 13);
      \u0275\u0275conditionalCreate(32, ConfigEditor_Conditional_32_Template, 2, 1, "div", 14);
      \u0275\u0275elementStart(33, "div", 15);
      \u0275\u0275conditionalCreate(34, ConfigEditor_Conditional_34_Template, 1, 1, "textarea", 16)(35, ConfigEditor_Conditional_35_Template, 2, 0, "div", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "div", 18)(37, "span");
      \u0275\u0275text(38);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(39, ConfigEditor_Conditional_39_Template, 2, 0, "span", 19);
      \u0275\u0275elementStart(40, "span", 20);
      \u0275\u0275text(41);
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(42, ConfigEditor_Conditional_42_Template, 61, 0, "app-help-modal", 21);
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.parseError() ? 31 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.statusMessage() ? 32 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.viewMode() === "code" ? 34 : 35);
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.helpOpen() ? 42 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigEditor, { className: "ConfigEditor", filePath: "src/app/pages/config-editor/config-editor.ts", lineNumber: 26 });
})();
export {
  ConfigEditor
};
//# sourceMappingURL=chunk-FK3UFVWT.js.map
