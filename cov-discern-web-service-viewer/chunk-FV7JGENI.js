...
function ServiceManager_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 22)(4, "code");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ServiceManager_For_15_Conditional_6_Template, 2, 0, "span", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_36_Conditional_18_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_36_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ServiceManager_Conditional_36_Conditional_18_For_2_Conditional_7_Template, 2, 0, "span", 42);
    \u0275\u0275elementStart(8, "button", 43);
    \u0275\u0275listener("click", function ServiceManager_Conditional_36_Conditional_18_For_2_Template_button_click_8_listener() {
      const \u0275$index_109_r6 = \u0275\u0275restoreView(_r5).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeParameterFromNew(\u0275$index_109_r6));
    });
...
function ServiceManager_Conditional_36_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275repeaterCreate(1, ServiceManager_Conditional_36_Conditional_18_For_2_Template, 11, 4, "div", 38, _forTrack2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_36_For_24_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ServiceManager_Conditional_36_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "input", 26);
    \u0275\u0275listener("ngModelChange", function ServiceManager_Conditional_36_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "textarea", 27);
    \u0275\u0275listener("ngModelChange", function ServiceManager_Conditional_36_Template_textarea_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ServiceManager_Conditional_36_Conditional_18_Template, 3, 0, "div", 28);
    \u0275\u0275elementStart(19, "div", 29)(20, "select", 30);
    \u0275\u0275listener("ngModelChange", function ServiceManager_Conditional_36_Template_select_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(23, ServiceManager_Conditional_36_For_24_Template, 2, 3, "option", 32, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "label", 33)(26, "input", 34);
    \u0275\u0275listener("ngModelChange", function ServiceManager_Conditional_36_Template_input_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_36_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_36_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_36_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ServiceManager_Conditional_37_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 47);
    \u0275\u0275listener("click", function ServiceManager_Conditional_37_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
...
function ServiceManager_Conditional_37_For_20_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 42);
    \u0275\u0275text(1, "required");
    \u0275\u0275elementEnd();
...
function ServiceManager_Conditional_37_For_20_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_37_For_20_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_37_For_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38)(1, "span", 39);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ServiceManager_Conditional_37_For_20_Conditional_7_Template, 2, 0, "span", 42)(8, ServiceManager_Conditional_37_For_20_Conditional_8_Template, 2, 0, "span", 48);
    \u0275\u0275conditionalCreate(9, ServiceManager_Conditional_37_For_20_Conditional_9_Template, 2, 1, "span", 49);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17)(1, "div", 44)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, ServiceManager_Conditional_37_Conditional_4_Template, 4, 0, "button", 45);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 46)(11, "label");
    ...
    \u0275\u0275repeaterCreate(19, ServiceManager_Conditional_37_For_20_Template, 10, 5, "div", 38, _forTrack2);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const svc_r10 = ctx;
...
function ServiceManager_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceManager_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-help-modal", 50);
    \u0275\u0275listener("closeRequested", function ServiceManager_Conditional_39_Template_app_help_modal_closeRequested_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
...
var ServiceManager = class _ServiceManager {
  ...
  /** Whether a DB load is in progress */
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceManager, selectors: [["app-service-manager"]], decls: 40, vars: 7, consts: [[1, "service-manager-layout"], [1, "service-list-panel"], [1, "panel-header"], [1, "panel-header-actions"], ["title", "Help", 1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn", "btn-small", "btn-primary", 3, "click"], [1, "service-list"], [1, "service-item", 3, "active"], [1, "panel-footer"], [1, "btn", "btn-small", "btn-secondary", 3, "click"], [1, "btn", "btn-small", "btn-secondary", "import-btn"], ["type", "file", "accept", ".json", "hidden", "", 3, "change"], [1, "btn", "btn-small", "btn-secondary", 3, "click", "disabled", "title"], [1, "import-message"], [1, "detail-panel"], [1, "add-new-form"], [1, "service-detail"], [1, "empty-state"], ["title", "Service Manager Help"], [1, "service-item", 3, "click"], [1, "service-item-name"], [1, "service-item-meta"], [1, "badge"], [1, "form-group"], ["type", "text", "placeholder", "e.g., cov_my_new_script", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., My New Script", 3, "ngModelChange", "ngModel"], ["rows", "3", "placeholder", "What does this service do?", 3, "ngModelChange", "ngModel"], [1, "param-list"], [1, "add-param-row"], [3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "checkbox-label"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], [1, "form-actions"], [1, "btn", "btn-primary", 3, "click"], [1, "btn", "btn-secondary", 3, "click"], [1, "param-item"], [1, "param-position"], [1, "param-name"], [1, "param-key"], [1, "badge", "required"], [1, "btn-icon", 3, "click"], [1, "detail-header"], [1, "btn", "btn-small", "btn-warn"], [1, "detail-field"], [1, "btn", "btn-small", "btn-warn", 3, "click"], [1, "badge", "optional"], [1, "param-default"], ["title", "Service Manager Help", 3, "closeRequested"]], template: function ServiceManager_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function ServiceManager_Template_button_click_26_listener() {
        return ctx.saveToDatabase();
      });
      \u0275\u0275elementStart(27, "span", 5);
      \u0275\u0275text(28, "cloud_upload");
      \u0275\u0275elementEnd();
      \u0275\u0275text(29, " Save to DB ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "button", 13);
      \u0275\u0275listener("click", function ServiceManager_Template_button_click_30_listener() {
        return ctx.loadFromDatabase();
      });
      \u0275\u0275elementStart(31, "span", 5);
      \u0275\u0275text(32, "cloud_download");
      \u0275\u0275elementEnd();
      \u0275\u0275text(33, " Load from DB ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(34, ServiceManager_Conditional_34_Template, 2, 1, "div", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(35, "div", 15);
      \u0275\u0275conditionalCreate(36, ServiceManager_Conditional_36_Template, 39, 6, "div", 16)(37, ServiceManager_Conditional_37_Template, 21, 5, "div", 17)(38, ServiceManager_Conditional_38_Template, 7, 0, "div", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(39, ServiceManager_Conditional_39_Template, 227, 0, "app-help-modal", 19);
    }
    if (rf & 2) {
      let tmp_5_0;
      let tmp_6_0;
      ...
      \u0275\u0275advance(12);
      \u0275\u0275property("disabled", !ctx.MPage.serviceReady || ctx.dbSaving())("title", ctx.MPage.serviceReady ? "Save configuration to Cerner database" : "Clinical Office not available");
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", !ctx.MPage.serviceReady || ctx.dbLoading())("title", ctx.MPage.serviceReady ? "Load configuration from Cerner database" : "Clinical Office not available");
      \u0275\u0275advance(4);
      \u0275\u0275conditional((tmp_5_0 = ctx.importMessage()) ? 34 : -1, tmp_5_0);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.addingNew() ? 36 : (tmp_6_0 = ctx.getSelectedService()) ? 37 : 38, tmp_6_0);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.helpOpen() ? 39 : -1);
    }
  ...
  <div class="service-list-panel">
    ...
    <div class="panel-footer">
      ...
      <button class="btn btn-small btn-secondary"
        ...
        [title]="MPage.serviceReady ? 'Save configuration to Cerner database' : 'Clinical Office not available'"
        (click)="saveToDatabase()">
        <span class="material-icons">cloud_upload</span> Save to DB
      </button>
      <button class="btn btn-small btn-secondary"
        [disabled]="!MPage.serviceReady || dbLoading()"
        [title]="MPage.serviceReady ? 'Load configuration from Cerner database' : 'Clinical Office not available'"
        (click)="loadFromDatabase()">
        <span class="material-icons">cloud_download</span> Load from DB
      </button>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServiceManager, { className: "ServiceManager", filePath: "src/app/pages/service-manager/service-manager.ts", lineNumber: 18 });
})();
export {
  ServiceManager
};
//# sourceMappingURL=chunk-FV7JGENI.js.map
