...
function Executor_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(18, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(19, Executor_Conditional_33_Conditional_19_Template, 2, 2, "div", 41);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Executor, { className: "Executor", filePath: "src/app/pages/executor/executor.ts", lineNumber: 20 });
})();
export {
  Executor
};
//# sourceMappingURL=chunk-IKIOVPJB.js.map
