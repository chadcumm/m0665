...
function Executor_Conditional_33_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39);
    \u0275\u0275element(1, "app-json-viewer", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const result_r8 = \u0275\u0275nextContext();
...
function Executor_Conditional_33_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "code", 38);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "button", 24);
    \u0275\u0275listener("click", function Executor_Conditional_33_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(14, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(15, Executor_Conditional_33_Conditional_15_Template, 2, 1, "div", 39);
    \u0275\u0275conditionalCreate(16, Executor_Conditional_33_Conditional_16_Template, 5, 1, "div", 40);
  }
  if (rf & 2) {
    const result_r8 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_35_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275conditionalCreate(6, Executor_Conditional_35_For_15_Conditional_6_Template, 2, 1, "span", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "code", 54);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
...
function Executor_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "div", 43)(2, "div", 44)(3, "h3");
    \u0275\u0275text(4, "Execution History");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 45)(6, "button", 24);
    ...
    \u0275\u0275repeaterCreate(14, Executor_Conditional_35_For_15_Template, 14, 15, "div", 47, _forTrack03);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-help-modal", 58);
...
var Executor = class _Executor {
  ...
  coButtonTooltip = computed(() => {
    ...
    return "Waiting for Clinical Office initialization...";
...
${JSON.stringify(ref, null, 2)}`);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Executor, selectors: [["app-executor"]], decls: 37, vars: 18, consts: [[1, "executor-layout"], [1, "left-panel"], [1, "left-panel-scroll"], [1, "service-selector"], [1, "service-selector-header"], [1, "service-selector-actions"], ["title", "Help", 1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn", "btn-ghost", "btn-small", 3, "click", "disabled"], [1, "btn", "btn-ghost", "btn-small"], [3, "change", "value"], [3, "value"], [1, "mode-toggle-section"], [1, "mode-label"], [1, "mode-toggle"], [1, "btn", "btn-small", 3, "click"], [1, "btn", "btn-small", 3, "click", "disabled", "title"], [1, "co-init-spinner"], [1, "reference-checkbox"], [1, "parameter-section"], [1, "status-message", "loading"], [1, "right-panel"], [1, "empty-state"], ["title", "Executor Help"], [1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "history-count"], [1, "service-description"], [1, "program-name"], [1, "label"], ["type", "checkbox", 3, "change", "checked"], [3, "executeRequested", "service", "executing"], [1, "spinner"], [1, "result-header"], [1, "result-info"], [1, "result-meta"], [1, "result-status"], [1, "result-mode"], [1, "result-duration"], [1, "result-params"], [1, "result-viewer"], [1, "error-panel"], [3, "data"], [1, "history-overlay", 3, "click"], [1, "history-drawer"], [1, "drawer-header"], [1, "drawer-actions"], [1, "drawer-body"], [1, "history-item", 3, "success", "error", "active"], [1, "history-item", 3, "click"], [1, "history-left"], [1, "history-status-dot"], [1, "history-info"], [1, "history-name"], [1, "history-mode-badge"], [1, "history-params"], [1, "history-right"], [1, "history-time"], [1, "history-duration"], ["title", "Executor Help", 3, "closeRequested"]], template: function Executor_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(33, Executor_Conditional_33_Template, 17, 11)(34, Executor_Conditional_34_Template, 7, 0, "div", 22);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(35, Executor_Conditional_35_Template, 16, 0);
      \u0275\u0275conditionalCreate(36, Executor_Conditional_36_Template, 238, 0, "app-help-modal", 23);
    }
    if (rf & 2) {
      let tmp_5_0;
      let tmp_12_0;
...
//# sourceMappingURL=chunk-KXPKME65.js.map
