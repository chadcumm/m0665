...
function ConfigEditor_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(24, "Service Registry");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "td");
    \u0275\u0275text(26, "Custom service definitions (dwsv_service_registry)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "tr")(28, "td")(29, "strong");
    \u0275\u0275text(30, "Full Bundle");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "td");
    \u0275\u0275text(32, "Combined export of all parameter types and services");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(33, "h2");
    \u0275\u0275text(34, "Views");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "ul")(36, "li")(37, "strong");
    \u0275\u0275text(38, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275text(39, " -- Raw JSON text editor. Edit directly, format with the Format button.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "li")(41, "strong");
    \u0275\u0275text(42, "Tree");
    \u0275\u0275elementEnd();
    \u0275\u0275text(43, " -- Interactive tree view. Expand/collapse nodes, edit values inline.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "h2");
    \u0275\u0275text(45, "Applying Changes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "p");
    \u0275\u0275text(47, "Click ");
    ...
    \u0275\u0275text(49, "Apply");
    \u0275\u0275elementEnd();
    \u0275\u0275text(50, " to write changes to localStorage. The app will reload the affected data immediately. For Full Bundle mode, both parameter types and services are updated.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "p")(52, "strong");
    \u0275\u0275text(53, "Warning:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(54, " Invalid JSON cannot be applied. Fix syntax errors first.");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(60, "Reset All");
    \u0275\u0275elementEnd();
    \u0275\u0275text(61, " to restore all parameter types and services to their default definitions. This removes all customizations and custom entries.");
    \u0275\u0275elementEnd()();
  }
}
var ConfigEditor = class _ConfigEditor {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigEditor, selectors: [["app-config-editor"]], viewQuery: function ConfigEditor_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(66);
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(67, ConfigEditor_Conditional_67_Template, 62, 0, "app-help-modal", 30);
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-KYHLWK5S.js.map
