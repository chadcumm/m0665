...
function ParameterManager_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "h2");
    \u0275\u0275text(6, "Default vs Custom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "ul")(8, "li")(9, "strong");
    \u0275\u0275text(10, "Default");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11, ' parameter types ship with the application. All fields are fully editable. Use "Reset to Default" to restore the original definition.');
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(34, "). Read-only on default types to prevent breaking references.");
    \u0275\u0275elementEnd()();
...
//# sourceMappingURL=chunk-NO3T2ZEL.js.map
