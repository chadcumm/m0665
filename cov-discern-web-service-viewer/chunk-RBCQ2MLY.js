...
function ServiceManager_For_15_Conditional_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-customized-dot", 19);
    \u0275\u0275listener("resetClicked", function ServiceManager_For_15_Conditional_6_Conditional_2_Template_app_customized_dot_resetClicked_0_listener() {
      \u0275\u0275restoreView(_r4);
      const svc_r2 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.resetService(svc_r2.id));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ServiceManager_For_15_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "default");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, ServiceManager_For_15_Conditional_6_Conditional_2_Template, 1, 1, "app-customized-dot", 18);
  }
  if (rf & 2) {
    const svc_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.registry.hasUserVersion(svc_r2.id) ? 2 : -1);
  }
}
function ServiceManager_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ServiceManager_For_15_Conditional_6_Template, 3, 1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_18_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ServiceManager_Conditional_18_Conditional_18_For_2_Conditional_7_Template, 2, 0, "span", 39);
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_18_Conditional_18_For_2_Template_button_click_8_listener() {
      const \u0275$index_84_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeParameterFromNew(\u0275$index_84_r7));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", p_r8.position, ".");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.getParamTypeLabel(p_r8.parameterTypeKey));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", p_r8.parameterTypeKey, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(p_r8.required ? 7 : -1);
  }
}
function ServiceManager_Conditional_18_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275repeaterCreate(1, ServiceManager_Conditional_18_Conditional_18_For_2_Template, 11, 4, "div", 35, _forTrack2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ServiceManager_Conditional_18_For_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", pt_r9.key);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", pt_r9.label, " (", pt_r9.key, ")");
  }
}
function ServiceManager_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ServiceManager_Conditional_18_Conditional_18_Template, 3, 0, "div", 24);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(23, ServiceManager_Conditional_18_For_24_Template, 2, 3, "option", 28, _forTrack1);
    \u0275\u0275elementEnd();
...
function ServiceManager_Conditional_19_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const svc_r12 = \u0275\u0275nextContext();
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.resetService(svc_r12.id));
    });
...
function ServiceManager_Conditional_19_Conditional_25_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_25_For_2_Template_button_click_7_listener() {
      const \u0275$index_190_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleParameterRequired(\u0275$index_190_r14));
    });
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_25_For_2_Template_button_click_9_listener() {
      const \u0275$index_190_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleParameterHidden(\u0275$index_190_r14));
    });
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("change", function ServiceManager_Conditional_19_Conditional_25_For_2_Template_input_change_11_listener($event) {
      const \u0275$index_190_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.updateParameterDefault(\u0275$index_190_r14, $event.target.value));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Conditional_25_For_2_Template_button_click_12_listener() {
      const \u0275$index_190_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeParameterFromService(\u0275$index_190_r14));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", p_r15.position, ".");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.getParamTypeLabel(p_r15.parameterTypeKey));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", p_r15.parameterTypeKey, ")");
    \u0275\u0275advance();
    \u0275\u0275classProp("required", p_r15.required)("optional", !p_r15.required);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r15.required ? "required" : "optional", " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("hidden-badge", p_r15.hidden);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r15.hidden ? "hidden" : "visible", " ");
    \u0275\u0275advance();
    \u0275\u0275property("value", p_r15.defaultValueOverride || "");
  }
}
function ServiceManager_Conditional_19_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275repeaterCreate(1, ServiceManager_Conditional_19_Conditional_25_For_2_Template, 15, 12, "div", 35, _forTrack2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const svc_r12 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(svc_r12.parameters);
  }
}
function ServiceManager_Conditional_19_For_31_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const pt_r16 = ctx.$implicit;
    \u0275\u0275property("value", pt_r16.key);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", pt_r16.label, " (", pt_r16.key, ")");
  }
}
function ServiceManager_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 41)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 42);
    \u0275\u0275conditionalCreate(5, ServiceManager_Conditional_19_Conditional_5_Template, 4, 0, "button", 43);
    \u0275\u0275elementStart(6, "button", 44);
    \u0275\u0275listener("click", function ServiceManager_Conditional_19_Template_button_click_6_listener() {
      const svc_r12 = \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeService(svc_r12.id));
    });
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(25, ServiceManager_Conditional_19_Conditional_25_Template, 3, 0, "div", 24);
    \u0275\u0275elementStart(26, "div", 25)(27, "select", 26);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(30, ServiceManager_Conditional_19_For_31_Template, 2, 3, "option", 28, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "label", 29)(33, "input", 30);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(svc_r12.displayName);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.registry.isDefault(svc_r12.id) && ctx_r2.registry.hasUserVersion(svc_r12.id) ? 5 : -1);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngModel", svc_r12.programName);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", svc_r12.displayName);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", svc_r12.description);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Parameters (", svc_r12.parameters.length, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(svc_r12.parameters.length ? 25 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.newParam().parameterTypeKey);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.parameterTypes());
        ...
        <div
          ...
          <div class="service-item-meta">
            ...
            @if (registry.isDefault(svc.id)) {
              ...
              @if (registry.hasUserVersion(svc.id)) {
                <app-customized-dot
                  tooltip="Customized from default"
                  [showReset]="true"
                  (resetClicked)="resetService(svc.id)" />
              }
            }
          </div>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServiceManager, { className: "ServiceManager", filePath: "src/app/pages/service-manager/service-manager.ts", lineNumber: 17 });
})();
export {
  ServiceManager
};
//# sourceMappingURL=chunk-RBCQ2MLY.js.map
