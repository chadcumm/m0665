...
function Executor_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Executor_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_For_15_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 16)(1, "input", 26);
    \u0275\u0275listener("change", function Executor_Conditional_25_Template_input_change_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "app-parameter-form", 27);
    \u0275\u0275listener("executeRequested", function Executor_Conditional_26_Template_app_parameter_form_executeRequested_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_29_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_29_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36);
    \u0275\u0275element(1, "app-json-viewer", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const result_r8 = \u0275\u0275nextContext();
...
function Executor_Conditional_29_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, Executor_Conditional_29_Conditional_7_Template, 2, 1, "span", 33);
    \u0275\u0275elementStart(8, "span", 34);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "code", 35);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "button", 21);
    \u0275\u0275listener("click", function Executor_Conditional_29_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(14, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(15, Executor_Conditional_29_Conditional_15_Template, 2, 1, "div", 36);
    \u0275\u0275conditionalCreate(16, Executor_Conditional_29_Conditional_16_Template, 5, 1, "div", 37);
  }
  if (rf & 2) {
    const result_r8 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "span", 7);
    \u0275\u0275text(2, "terminal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3");
...
function Executor_Conditional_31_For_15_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_31_For_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 45);
    \u0275\u0275listener("click", function Executor_Conditional_31_For_15_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(5);
    \u0275\u0275conditionalCreate(6, Executor_Conditional_31_For_15_Conditional_6_Template, 2, 1, "span", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "code", 51);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
...
function Executor_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Executor_Conditional_31_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleHistory());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "div", 40)(2, "div", 41)(3, "h3");
    \u0275\u0275text(4, "Execution History");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 42)(6, "button", 21);
    \u0275\u0275listener("click", function Executor_Conditional_31_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function Executor_Conditional_31_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleHistory());
    });
    ...
    \u0275\u0275repeaterCreate(14, Executor_Conditional_31_For_15_Template, 14, 15, "div", 44, _forTrack03);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
${JSON.stringify(ref, null, 2)}`);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Executor, selectors: [["app-executor"]], decls: 32, vars: 16, consts: [[1, "executor-layout"], [1, "left-panel"], [1, "left-panel-scroll"], [1, "service-selector"], [1, "service-selector-header"], [1, "service-selector-actions"], [1, "btn", "btn-ghost", "btn-small", 3, "click", "disabled"], [1, "material-icons"], [1, "btn", "btn-ghost", "btn-small"], [3, "change", "value"], [3, "value"], [1, "mode-toggle-section"], [1, "mode-label"], [1, "mode-toggle"], [1, "btn", "btn-small", 3, "click"], [1, "btn", "btn-small", 3, "click", "disabled", "title"], [1, "reference-checkbox"], [1, "parameter-section"], [1, "status-message", "loading"], [1, "right-panel"], [1, "empty-state"], [1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "history-count"], [1, "service-description"], [1, "program-name"], [1, "label"], ["type", "checkbox", 3, "change", "checked"], [3, "executeRequested", "service", "executing"], [1, "spinner"], [1, "result-header"], [1, "result-info"], [1, "result-meta"], [1, "result-status"], [1, "result-mode"], [1, "result-duration"], [1, "result-params"], [1, "result-viewer"], [1, "error-panel"], [3, "data"], [1, "history-overlay", 3, "click"], [1, "history-drawer"], [1, "drawer-header"], [1, "drawer-actions"], [1, "drawer-body"], [1, "history-item", 3, "success", "error", "active"], [1, "history-item", 3, "click"], [1, "history-left"], [1, "history-status-dot"], [1, "history-info"], [1, "history-name"], [1, "history-mode-badge"], [1, "history-params"], [1, "history-right"], [1, "history-time"], [1, "history-duration"]], template: function Executor_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(10, "data_object");
      \u0275\u0275elementEnd();
      \u0275\u0275text(11);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(12, Executor_Conditional_12_Template, 6, 1, "button", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(13, "select", 9);
      \u0275\u0275listener("change", function Executor_Template_select_change_13_listener($event) {
        return ctx.selectService($event.target.value);
      });
      \u0275\u0275repeaterCreate(14, Executor_For_15_Template, 2, 2, "option", 10, _forTrack03);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(16, Executor_Conditional_16_Template, 7, 2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 11)(18, "span", 12);
      \u0275\u0275text(19, "Mode");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "div", 13)(21, "button", 14);
      \u0275\u0275listener("click", function Executor_Template_button_click_21_listener() {
        return ctx.setMode("raw");
      });
      \u0275\u0275text(22, " Raw ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "button", 15);
      \u0275\u0275listener("click", function Executor_Template_button_click_23_listener() {
        return ctx.setMode("clinical-office");
      });
      \u0275\u0275text(24, " Clinical Office ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(25, Executor_Conditional_25_Template, 3, 1, "label", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(26, Executor_Conditional_26_Template, 2, 2, "div", 17);
      \u0275\u0275conditionalCreate(27, Executor_Conditional_27_Template, 4, 0, "div", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(28, "div", 19);
      \u0275\u0275conditionalCreate(29, Executor_Conditional_29_Template, 17, 11)(30, Executor_Conditional_30_Template, 7, 0, "div", 20);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(31, Executor_Conditional_31_Template, 16, 0);
    }
    if (rf & 2) {
      let tmp_5_0;
      let tmp_11_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.history().length > 0 ? 12 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("value", ctx.selectedServiceId());
      \u0275\u0275advance();
      \u0275\u0275repeater(ctx.services());
      \u0275\u0275advance(2);
      \u0275\u0275conditional((tmp_5_0 = ctx.selectedService()) ? 16 : -1, tmp_5_0);
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.executionMode() === "clinical-office" ? 25 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional((tmp_11_0 = ctx.selectedService()) ? 26 : -1, tmp_11_0);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.executing() ? 27 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional((tmp_13_0 = ctx.currentResult()) ? 29 : 30, tmp_13_0);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.historyOpen() ? 31 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Executor, { className: "Executor", filePath: "src/app/pages/executor/executor.ts", lineNumber: 18 });
})();
export {
  Executor
};
//# sourceMappingURL=chunk-WS5VENMT.js.map
