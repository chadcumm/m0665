...
function Executor_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 17)(1, "input", 28);
    \u0275\u0275listener("change", function Executor_Conditional_28_Template_input_change_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18)(1, "app-parameter-form", 29);
    \u0275\u0275listener("executeRequested", function Executor_Conditional_29_Template_app_parameter_form_executeRequested_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_32_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(result_r8.executionMode === "raw" ? "Raw" : "CO");
  }
}
function Executor_Conditional_32_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275element(1, "app-json-viewer", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const result_r8 = \u0275\u0275nextContext();
...
function Executor_Conditional_32_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function Executor_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 32)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 33)(5, "span", 34);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, Executor_Conditional_32_Conditional_7_Template, 2, 1, "span", 35);
    \u0275\u0275elementStart(8, "span", 36);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "code", 37);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "button", 23);
    \u0275\u0275listener("click", function Executor_Conditional_32_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(14, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(15, Executor_Conditional_32_Conditional_15_Template, 2, 1, "div", 38);
    \u0275\u0275conditionalCreate(16, Executor_Conditional_32_Conditional_16_Template, 5, 1, "div", 39);
  }
  if (rf & 2) {
    const result_r8 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275conditional(result_r8.success && result_r8.response ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(result_r8.errorMessage ? 16 : -1);
  }
}
function Executor_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "span", 7);
    \u0275\u0275text(2, "terminal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3");
...
function Executor_Conditional_34_For_15_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(entry_r11.executionMode === "raw" ? "Raw" : "CO");
  }
}
function Executor_Conditional_34_For_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 47);
    \u0275\u0275listener("click", function Executor_Conditional_34_For_15_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(5);
    \u0275\u0275conditionalCreate(6, Executor_Conditional_34_For_15_Conditional_6_Template, 2, 1, "span", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "code", 53);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
...
function Executor_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Executor_Conditional_34_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleHistory());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "div", 42)(2, "div", 43)(3, "h3");
    \u0275\u0275text(4, "Execution History");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 44)(6, "button", 23);
    \u0275\u0275listener("click", function Executor_Conditional_34_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function Executor_Conditional_34_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleHistory());
    });
    ...
    \u0275\u0275repeaterCreate(14, Executor_Conditional_34_For_15_Template, 14, 15, "div", 46, _forTrack03);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function Executor_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-help-modal", 57);
    \u0275\u0275listener("closeRequested", function Executor_Conditional_35_Template_app_help_modal_closeRequested_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.helpOpen.set(false));
    });
    \u0275\u0275elementStart(1, "h2");
    \u0275\u0275text(2, "Service Selector");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "The ");
    ...
    \u0275\u0275text(6, "Service");
    \u0275\u0275elementEnd();
    \u0275\u0275text(7, " dropdown lists all registered CCL web services. Select a service to load its parameter form.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ul")(9, "li")(10, "strong");
    \u0275\u0275text(11, "Program name");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " is the actual CCL program that will be called");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "li")(14, "strong");
    \u0275\u0275text(15, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275text(16, " explains what data the service returns");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "h2");
    \u0275\u0275text(18, "Parameters");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p");
    \u0275\u0275text(20, "Each service defines positional parameters. The form renders the appropriate input for each one.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "h3");
    \u0275\u0275text(22, "Field Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "table")(24, "thead")(25, "tr")(26, "th");
    \u0275\u0275text(27, "Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "th");
    \u0275\u0275text(29, "Description");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(30, "tbody")(31, "tr")(32, "td")(33, "strong");
    \u0275\u0275text(34, "Text");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "td");
    \u0275\u0275text(36, "Free-text input. Type any string value.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "tr")(38, "td")(39, "strong");
    \u0275\u0275text(40, "Select");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "td");
    \u0275\u0275text(42, "Dropdown with predefined options.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "tr")(44, "td")(45, "strong");
    \u0275\u0275text(46, "DateTime");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "td");
    \u0275\u0275text(48, "Date and time picker. Quick presets available (Today Start, Yesterday Start, Now).");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "tr")(50, "td")(51, "strong");
    \u0275\u0275text(52, "Date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "td");
    \u0275\u0275text(54, "Date-only picker with presets.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "tr")(56, "td")(57, "strong");
    \u0275\u0275text(58, "Time");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "td");
    \u0275\u0275text(60, "Time-only picker with presets.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "tr")(62, "td")(63, "strong");
    \u0275\u0275text(64, "Number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(65, "td");
    \u0275\u0275text(66, "Numeric input. Sent unquoted to CCL (no ^caret^ wrapping).");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(67, "tr")(68, "td")(69, "strong");
    \u0275\u0275text(70, "Hidden");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(71, "td");
    \u0275\u0275text(72, "Not shown in the form. Uses its default value automatically.");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(73, "h3");
    \u0275\u0275text(74, "Required vs Optional");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "ul")(76, "li");
    \u0275\u0275text(77, "Fields marked with a red ");
    \u0275\u0275elementStart(78, "strong");
    \u0275\u0275text(79, "*");
    \u0275\u0275elementEnd();
    \u0275\u0275text(80, " are required");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "li");
    \u0275\u0275text(82, "Optional fields can be left empty \u2014 sent as ");
    \u0275\u0275elementStart(83, "code");
    \u0275\u0275text(84, "^^");
    \u0275\u0275elementEnd();
    \u0275\u0275text(85, " (empty carets) to CCL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "li");
    \u0275\u0275text(87, "Default values are pre-populated from the parameter library or service definition");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(88, "h3");
    \u0275\u0275text(89, "How Parameters Are Sent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "p");
    \u0275\u0275text(91, "In ");
    ...
    \u0275\u0275text(93, "Raw mode");
    \u0275\u0275elementEnd();
    \u0275\u0275text(94, ", parameters are assembled into a positional string:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "pre")(96, "code");
    \u0275\u0275text(97, "^MINE^,^ClinicalDoc^,^^,^CMC^,^19-MAR-2026 00:00:00^");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(98, "ul")(99, "li");
    \u0275\u0275text(100, "String values are wrapped in ");
    \u0275\u0275elementStart(101, "code");
    \u0275\u0275text(102, "^carets^");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(103, "li");
    \u0275\u0275text(104, "Numeric values are sent bare: ");
    ...
    \u0275\u0275text(111, "Empty optional parameters are sent as ");
    \u0275\u0275elementStart(112, "code");
    \u0275\u0275text(113, "^^");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(114, "li");
    \u0275\u0275text(115, "Order matters \u2014 parameters are sorted by position number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(116, "p");
    \u0275\u0275text(117, "In ");
    \u0275\u0275elementStart(118, "strong");
    \u0275\u0275text(119, "Clinical Office mode");
    \u0275\u0275elementEnd();
    \u0275\u0275text(120, ", parameters are sent as named key-value pairs.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "h2");
    \u0275\u0275text(122, "Execution Modes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(123, "h3");
    \u0275\u0275text(124, "Raw Mode");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(125, "p");
    \u0275\u0275text(126, "Uses the native ");
    \u0275\u0275elementStart(127, "code");
    \u0275\u0275text(128, "XMLCclRequest");
    \u0275\u0275elementEnd();
    \u0275\u0275text(129, " object in PowerChart. Sends the positional parameter string exactly as CCL expects it.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(130, "p")(131, "strong");
    \u0275\u0275text(132, "Use Raw mode when:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(133, "ul")(134, "li");
    \u0275\u0275text(135, "Testing any CCL script for the first time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(136, "li");
    \u0275\u0275text(137, "You need exact control over the parameter string");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(138, "li");
    \u0275\u0275text(139, "The CCL script was written for positional prompt invocation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(140, "h3");
    \u0275\u0275text(141, "Clinical Office Mode");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(142, "p");
    \u0275\u0275text(143, "Uses the Clinical Office ");
    \u0275\u0275elementStart(144, "code");
    \u0275\u0275text(145, "CustomService");
    \u0275\u0275elementEnd();
    \u0275\u0275text(146, " framework with automatic JSON parsing, error handling, and Reference Service support.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "p")(148, "strong");
    \u0275\u0275text(149, "Use Clinical Office mode when:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(150, "ul")(151, "li");
    \u0275\u0275text(152, "You want to collect Reference Service metadata about response fields");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(153, "li");
    \u0275\u0275text(154, "The CCL script supports Clinical Office named parameter mapping");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(155, "li");
    \u0275\u0275text(156, "You need patient context binding (personId/encntrId)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(157, "p")(158, "strong");
    \u0275\u0275text(159, "Note:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(160, " The Clinical Office button is disabled if the framework is not initialized.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(161, "h3");
    \u0275\u0275text(162, "Include Reference");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(163, "p");
    \u0275\u0275text(164, "When checked (Clinical Office mode only), adds ");
    \u0275\u0275elementStart(165, "code");
    \u0275\u0275text(166, "reference: true");
    \u0275\u0275elementEnd();
    \u0275\u0275text(167, " to the payload. This tells the CCL script to return metadata about its fields. Reference data appears in the MPage log.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(168, "h2");
    \u0275\u0275text(169, "Load Reference Button");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(170, "p");
    \u0275\u0275text(171, "Loads Reference Service data for all built-in services (Address, Allergy, Diagnosis, etc.). Results are logged to the ");
    \u0275\u0275elementStart(172, "strong");
    \u0275\u0275text(173, "MPage Log");
    \u0275\u0275elementEnd();
    \u0275\u0275text(174, " panel at the bottom of the screen. Does not affect normal execution.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(175, "h2");
    \u0275\u0275text(176, "Results Panel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(177, "h3");
    \u0275\u0275text(178, "Status Indicators");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(179, "ul")(180, "li")(181, "strong");
    \u0275\u0275text(182, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275text(183, " (green) \u2014 CCL script returned data successfully");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(184, "li")(185, "strong");
    \u0275\u0275text(186, "Failed");
    \u0275\u0275elementEnd();
    \u0275\u0275text(187, " (red) \u2014 An error occurred");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(188, "h3");
    \u0275\u0275text(189, "JSON Viewer Modes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(190, "table")(191, "thead")(192, "tr")(193, "th");
    \u0275\u0275text(194, "Mode");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(195, "th");
    \u0275\u0275text(196, "Description");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(197, "tbody")(198, "tr")(199, "td")(200, "strong");
    \u0275\u0275text(201, "Tree");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(202, "td");
    \u0275\u0275text(203, "Interactive expandable tree view. Search and copy paths.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(204, "tr")(205, "td")(206, "strong");
    \u0275\u0275text(207, "Code");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(208, "td");
    \u0275\u0275text(209, "Syntax-highlighted raw JSON. Best for copying the full response.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(210, "tr")(211, "td")(212, "strong");
    \u0275\u0275text(213, "Table");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(214, "td");
    \u0275\u0275text(215, "Auto-detects arrays and renders as tables. Nested arrays are expandable.");
    \u0275\u0275elementEnd()()()();
    ...
    \u0275\u0275text(221, "History");
    \u0275\u0275elementEnd();
    \u0275\u0275text(222, " to open the execution history drawer (last 50 executions).");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(223, "ul")(224, "li")(225, "strong");
    \u0275\u0275text(226, "Green dot");
    \u0275\u0275elementEnd();
    \u0275\u0275text(227, " = successful execution");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(228, "li")(229, "strong");
    \u0275\u0275text(230, "Red dot");
    \u0275\u0275elementEnd();
    \u0275\u0275text(231, " = failed execution");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(232, "li")(233, "strong");
    \u0275\u0275text(234, "Mode badge");
    \u0275\u0275elementEnd();
    \u0275\u0275text(235, ' = "Raw" or "CO"');
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(236, "li");
    \u0275\u0275text(237, "Click any entry to reload its result");
    \u0275\u0275elementEnd()()();
  }
}
...
${JSON.stringify(ref, null, 2)}`);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Executor, selectors: [["app-executor"]], decls: 36, vars: 17, consts: [[1, "executor-layout"], [1, "left-panel"], [1, "left-panel-scroll"], [1, "service-selector"], [1, "service-selector-header"], [1, "service-selector-actions"], ["title", "Help", 1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn", "btn-ghost", "btn-small", 3, "click", "disabled"], [1, "btn", "btn-ghost", "btn-small"], [3, "change", "value"], [3, "value"], [1, "mode-toggle-section"], [1, "mode-label"], [1, "mode-toggle"], [1, "btn", "btn-small", 3, "click"], [1, "btn", "btn-small", 3, "click", "disabled", "title"], [1, "reference-checkbox"], [1, "parameter-section"], [1, "status-message", "loading"], [1, "right-panel"], [1, "empty-state"], ["title", "Executor Help"], [1, "btn", "btn-ghost", "btn-small", 3, "click"], [1, "history-count"], [1, "service-description"], [1, "program-name"], [1, "label"], ["type", "checkbox", 3, "change", "checked"], [3, "executeRequested", "service", "executing"], [1, "spinner"], [1, "result-header"], [1, "result-info"], [1, "result-meta"], [1, "result-status"], [1, "result-mode"], [1, "result-duration"], [1, "result-params"], [1, "result-viewer"], [1, "error-panel"], [3, "data"], [1, "history-overlay", 3, "click"], [1, "history-drawer"], [1, "drawer-header"], [1, "drawer-actions"], [1, "drawer-body"], [1, "history-item", 3, "success", "error", "active"], [1, "history-item", 3, "click"], [1, "history-left"], [1, "history-status-dot"], [1, "history-info"], [1, "history-name"], [1, "history-mode-badge"], [1, "history-params"], [1, "history-right"], [1, "history-time"], [1, "history-duration"], ["title", "Executor Help", 3, "closeRequested"]], template: function Executor_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(28, Executor_Conditional_28_Template, 3, 1, "label", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(29, Executor_Conditional_29_Template, 2, 2, "div", 18);
      \u0275\u0275conditionalCreate(30, Executor_Conditional_30_Template, 4, 0, "div", 19);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(31, "div", 20);
      \u0275\u0275conditionalCreate(32, Executor_Conditional_32_Template, 17, 11)(33, Executor_Conditional_33_Template, 7, 0, "div", 21);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(34, Executor_Conditional_34_Template, 16, 0);
      \u0275\u0275conditionalCreate(35, Executor_Conditional_35_Template, 238, 0, "app-help-modal", 22);
    }
    if (rf & 2) {
      let tmp_5_0;
      let tmp_11_0;
      ...
      \u0275\u0275property("disabled", !ctx.MPage.serviceReady)("title", ctx.MPage.serviceReady ? "Execute via Clinical Office CustomService" : "Clinical Office not ready");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.executionMode() === "clinical-office" ? 28 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional((tmp_11_0 = ctx.selectedService()) ? 29 : -1, tmp_11_0);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.executing() ? 30 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional((tmp_13_0 = ctx.currentResult()) ? 32 : 33, tmp_13_0);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.historyOpen() ? 34 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.helpOpen() ? 35 : -1);
    }
      ...
      <div class="mode-toggle-section">
        ...
        <div class="mode-toggle">
          ...
          <button class="btn btn-small"
            ...
            [title]="MPage.serviceReady ? 'Execute via Clinical Office CustomService' : 'Clinical Office not ready'"
        ...
        <div class="result-info">
          ...
          <div class="result-meta">
            ...
            @if (result.executionMode) {
              <span class="result-mode">{{ result.executionMode === 'raw' ? 'Raw' : 'CO' }}</span>
            }
            ...
            <div class="history-info">
              <span class="history-name">
                ...
                @if (entry.executionMode) {
                  <span class="history-mode-badge">{{ entry.executionMode === 'raw' ? 'Raw' : 'CO' }}</span>
                }
              </span>
...
//# sourceMappingURL=chunk-Y2ECBKYU.js.map
